...
function configDriver (done) {
  ...
  driver.findElement(By.css('.act')).click().then(() => { done() })
}
...
test.describe('Testing ', function () {
  ...
  test.it('Verify craigslist activity page is loaded', function () {
    driver.getCurrentUrl().then(function (url) {
      expect(url).to.be.equal('https://montreal.craigslist.ca/search/act')
    })
  })
})
